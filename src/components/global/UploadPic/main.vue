    ...
    down (type) {
      ...
      if (type === 'blob') {
        this.$refs.cropper.getCropBlob(data => {
          ...
          // formData.append('img', this.downImg)
          formData.append('img', data, 'aa.txt')
          HeadPortrait(formData).then((res) => {
            if (res.code === 200) {
              this.$emit('getPic', res.data.pic)
            }
          })
          // axios({
          //   method: 'post',
          //   url: 'http://58.248.91.71:8888/hjgwebsite/avatar',
          //   data: formData,
          ...
          // })
          //   .then(res => {
          //     this.$emit('getPic', res.data.data.pic)
          //   })
          //   .catch(error => {
          //     console.log(error)
          //   })
